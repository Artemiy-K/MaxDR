  ...
  meeting: [
    {
      ...
      image: "/vstrecha1.jpg",
      answer: "встреча с саней", // fix встреча с саней
    },
    {
      prompt: "Опиши, что происходит на картинке",
      image: "/vstrecha2.jpg",
      answer: "встреча возле синей машины", // fix встреча возле синей машины
    },
    {
      prompt: "Опиши, что происходит на картинке",
      image: "/vstrecha3.jpg",
      answer: "встреча на горе", // fix встреча на горе
    },
    {
      prompt: "Каким 1 словом можно объединить эти 3 фотографии",
      answer: "встреча", // fix встреча
    },
  ],
  frage: [
    {
